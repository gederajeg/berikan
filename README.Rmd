...
- direktori [`figs`](https://github.com/gederajeg/berikan/tree/main/figs) menyimpan luaran visualisasi statistik yang dihasilkan melalui [`analysis-code.R`](https://github.com/gederajeg/berikan/blob/main/analysis-code.R) dan juga gambar [jejaring konstruksional](https://github.com/gederajeg/berikan/blob/main/figs/network.pdf) yang dilaporkan dalam makalah.
